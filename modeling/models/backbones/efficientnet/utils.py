"""loading.py - Helper functions for building the model and for loading model parameters.
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
                 dropout_rate=0.2, drop_connect_rate=0.2, num_classes=1000, include_top=True, out_stride=32):
