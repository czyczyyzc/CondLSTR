...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, norm_layer=nn.BatchNorm2d):
...
class ShuffleNetV2(nn.Module):
    def __init__(self, stages_repeats, stages_out_channels, num_classes=1000,
                 inverted_residual=InvertedResidual, norm_layer=nn.BatchNorm2d):
...
def shufflenet_v2_x0_5(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, shows a progress bar of the download to stderr
    """
