...
class ResNeXt(ResNet):
    ...
    init_settings = {
        50:  dict(type='Pretrained', checkpoint='open-mmlab://resnext50_32x4d'),
        101: dict(type='Pretrained', checkpoint='open-mmlab://resnext101_32x4d'),
        152: dict(type='Pretrained', checkpoint='open-mmlab://resnext152_32x4d'),
    }
