...
file_path1 = '/data/chenziye/PersFormer_3DLane/result_3d/validation'
file_path2 = '/data/chenziye/HDMapNet/output/test_bev_cond_lstr_attr_swap_data_aug_no_smooth/validation'
...
for test_case in ['validation']:
    ...
    for idx in tqdm(range(len(file_list0))):
        ...
        if '150914281283375000' in ann_path0 or '150690717081847900' in ann_path0:
            print(ann_path0)
        else:
            continue
