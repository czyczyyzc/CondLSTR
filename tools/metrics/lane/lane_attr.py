...
if __name__ == "__main__":
    metric = LaneAttrMetric(distance_thr=10)
    ...
    anno_list = ['s3://perceptor-share/data/lane_data_3d/train/changshu_backflow_6_cam_15_reformat.json']
    pred_list = ['/data/HDMapNet/output/test_changshu_lmj_all_2/lane_points.json']
                ...
                with refile.smart_open(fpath, "r") as f:
                    for line in f.readlines():
                        try:
                            ...
                            pred_dict[nori_id] = sample['2d_res']
                        except:
                            continue
                ...
                with refile.smart_open(fpath, "r") as f:
                    ...
                    for i, frame in enumerate(frames):
                        ...
                        if nori_id in pred_dict:
                            anno_dict[nori_id] = []
                            for idx, lane in frame['rv']['camera_15']['lane'].items():
