...
class OpenLaneDataset(Dataset):
    ...
    def __init__(self, root, split='train', transform=None, version='v1.0'):
        ...
        self.ann_file = os.path.join(self.root, 'openlane_infos_{}_{}.pkl'.format(self.split, self.version))
    ...
    def __getitem__(self, index):
        ...
        input_dict['filename'] = ','.join(file_name.split('/')[-2:])
